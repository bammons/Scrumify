	...
	init: function() {
		...
		this.allScenes = {
			...
			Scene7: ['SK: I can sense another page near by! I think its in that chest!',
						...
						'SK: Im not falling for that this time phantom…',
						'FSKP: No, its true! I swear on my life! (chuckle)',
						'SK: When youre done playing games, I have a quest to finish Phantom.',
						'FSKP: Alright...alright….I wasnt joking, you do actually have to run into it.',
						'SK: (Angry Growl)'],
